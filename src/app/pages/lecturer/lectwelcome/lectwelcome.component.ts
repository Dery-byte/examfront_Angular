...
@Component({
  selector: 'app-lectwelcome',
  templateUrl: './lectwelcome.component.html',
  styleUrls: ['./lectwelcome.component.css']
})
export class LectwelcomeComponent {
  ...
  // allReports() {
  //   this._report.getCategoriesFromReport().subscribe((data) => {
  //     this.cateGory = data;
